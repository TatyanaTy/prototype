...
# ========================================
# ⚠️ ЭТОТ ТЕСТ СПЕЦИАЛЬНО ПАДАЕТ
# Он нужен для демонстрации работы CI/CD
# ========================================
def test_this_will_fail():
    """ТЕСТ 6: Демонстрационный падающий тест"""
    original = Product("Тест", "Тестовый", 100)
    cloned = original.clone()
    
    # Специально делаем неправильную проверку
    # assert проверяет, что original и cloned - ОДИН объект
    # Но это не так! Поэтому тест упадет
